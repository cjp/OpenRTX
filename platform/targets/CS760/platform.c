...
SPI_BITBANG_DEVICE_DEFINE(spiSr, NULL, spiSrConfig)
GPIO_SHIFTREG_DEVICE_DEFINE(extGpio, &spiSr, shiftRegStrobe, 24)
...
void platform_init()
{
    ...
    gpio_setMode(MAIN_PWR_DET, INPUT);
...
bool platform_pwrButtonStatus()
{
     ...
     */
    return (gpio_readPin(MAIN_PWR_DET) != 0) ? true : false;
}
